...
<p align="center">
  <b>⚠️ Используйте материалы исключительно в личных образовательных целях.</b>
  <br>
  Убедитесь, что скачивание не нарушает условия использования платформы GetCourse.
</p>
